...
class PoemTags extends React.Component {
    ...
    getLanguage() {
        ...
        AsyncStorage.getItem("@MySuperStore:language").then((chosenLanguage) => {
            ...
            if (chosenLanguage == 'english') {
                ...
                this.setState({ language: language.english, script: language.english.poemUrl });
    ...
    render() {
        ...
        header = <Header noShadow style={{ backgroundColor:setting.poem_color,marginTop: 0, paddingTop: 60,paddingBottom:40, elevation: 0 }}>
            <Left><Button transparent
                onPress={() => this.props.navigation.navigate("DrawerOpen")}
            ><Icon name="menu" /></Button></Left>
            <Body>
                <Title><Image style={{width:50,height:50}}source={{uri:'http://novasyon.net/images/nova.png'}} /> {this.state.language.tabTag}</Title>
            </Body>
            <Right />
        </Header>
