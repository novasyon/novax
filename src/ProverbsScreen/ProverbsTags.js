...
class ProverbsTags extends React.Component {
    ...
    _renderTags() {
        ...
        console.log("Tags=",this.state.tags[0]);
    ...
    render() {
        ...
        header = <Header noShadow style={{ backgroundColor:setting.proverb_color,marginTop: 0, paddingTop: 60,paddingBottom:40, elevation: 0 }}>
